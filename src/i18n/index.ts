...
const translations = {
  zh: {
    ...
    promptManagerDescription: '管理和组织您的 AI 绘画提示词，支持多行编辑、分类标记和历史记录',
    promptTitle: '标题/注释',
    promptContent: 'Prompt 内容',
    promptTitlePlaceholder: '为这个 Prompt 添加一个标题或注释（可选）',
    promptContentPlaceholder: '输入您的 Prompt 内容，支持逗号分隔的标签格式，如：\n1boy, very short hair, brown hair, blue eyes, anime style, detailed',
    promptInputTip: '支持多行输入，逗号分隔的内容会自动识别为标签',
    promptInputHelpText: '您可以输入任何形式的 Prompt，系统会自动将逗号分隔的内容识别为标签，方便后续搜索和管理。',
    optional: '可选',
    savePrompt: '保存 Prompt',
    saving: '保存中',
    savePromptFailed: '保存 Prompt 失败，请重试',
    searchPrompts: '搜索 Prompt 标题或内容...',
    prompts: '个 Prompt',
    allPrompts: '所有 Prompt',
    promptsOnDate: '的 Prompt',
    promptsOnThisDate: '个 Prompt',
    noPromptsOnThisDate: '这一天没有 Prompt',
    noPromptsOnDateDescription: '在选定的日期没有保存任何 Prompt',
    noPromptsYet: '还没有 Prompt',
    addFirstPrompt: '添加您的第一个 Prompt 来开始管理您的创作灵感',
    tryDifferentSearch: '尝试使用不同的关键词进行搜索',
    clearAllPrompts: '清空所有 Prompt',
    clearAllPromptsConfirm: '确定要清空所有 Prompt 吗？此操作不可撤销。',
    clearPromptsFailed: '清空 Prompt 失败，请重试',
    noTitle: '无标题',
    created: '创建于',
    ...
    deletePromptFailed: '删除 Prompt 失败，请重试',
    updatePromptFailed: '更新 Prompt 失败，请重试',
    showLess: '收起',
    more: '更多',
    tip: '提示',
    viewPrompts: '查看 Prompt',
    
    // 日历和日期块相关
    calendarDescription: '查看您的 Prompt 创作历史和活动统计',
    showPromptCalendar: '显示日历',
    hidePromptCalendar: '隐藏日历',
    showDateBlocks: '显示日期块',
    hideDateBlocks: '隐藏日期块',
    dateBlocks: '日期块',
    totalDatesWithPrompts: '共 {count} 个有 Prompt 的日期',
    noDateBlocksYet: '还没有创建任何 Prompt',
    dates: '个日期',
    exportDatePrompts: '导出该日期的 Prompt',
    ...
    noPromptsToExport: '没有 Prompt 可以导出',
    exportPromptFailed: '导出失败，请重试',
  ...
  en: {
    ...
    loraModelManager: 'LoRA Model Manager',
    fetching: 'Fetching...',
    ...
    promptManagerDescription: 'Manage and organize your AI art prompts with multi-line editing, categorization, and history tracking',
    promptTitle: 'Title/Comment',
    promptContent: 'Prompt Content',
    promptTitlePlaceholder: 'Add a title or comment for this prompt (optional)',
    promptContentPlaceholder: 'Enter your prompt content, supports comma-separated tag format, like:\n1boy, very short hair, brown hair, blue eyes, anime style, detailed',
    promptInputTip: 'Supports multi-line input, comma-separated content will be automatically recognized as tags',
    promptInputHelpText: 'You can enter prompts in any format. The system will automatically recognize comma-separated content as tags for easy searching and management.',
    optional: 'optional',
    savePrompt: 'Save Prompt',
    saving: 'Saving',
    savePromptFailed: 'Failed to save prompt, please try again',
    searchPrompts: 'Search prompt titles or content...',
    prompts: 'prompts',
    allPrompts: 'All Prompts',
    promptsOnDate: 'Prompts on',
    promptsOnThisDate: 'prompts',
    noPromptsOnThisDate: 'No prompts on this date',
    noPromptsOnDateDescription: 'No prompts saved on the selected date',
    noPromptsYet: 'No prompts yet',
    addFirstPrompt: 'Add your first prompt to start managing your creative inspiration',
    tryDifferentSearch: 'Try using different keywords to search',
    clearAllPrompts: 'Clear All Prompts',
    clearAllPromptsConfirm: 'Are you sure you want to clear all prompts? This action cannot be undone.',
    clearPromptsFailed: 'Failed to clear prompts, please try again',
    noTitle: 'No title',
    created: 'Created at',
    ...
    // Calendar and date blocks
    calendarDescription: 'View your Prompt creation history and activity statistics',
    showPromptCalendar: 'Show Calendar',
    hidePromptCalendar: 'Hide Calendar',
    showDateBlocks: 'Show Date Blocks',
    hideDateBlocks: 'Hide Date Blocks',
    dateBlocks: 'Date Blocks',
    totalDatesWithPrompts: '{count} dates with prompts',
    noDateBlocksYet: 'No prompts created yet',
    dates: 'dates',
    exportDatePrompts: 'Export prompts for this date',
    ...
    exportPromptFailed: 'Export failed, please try again',
